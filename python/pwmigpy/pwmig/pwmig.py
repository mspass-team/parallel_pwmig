...
class worker_memory_estimator:
    ...
    def __init__(self, db, sid, pf, source_collection=None):
    ...
    @staticmethod
    def input_data_size(db, sid, source_collection=None):
        """
        ...
        if source_collection:
            ...
            # normal use should use this one - generated by pwstack
            # to make output independet of source_colleciton.
            idname = "pwmig_source_id"
        # make sure we get a valid gridid - this may not be necessary
        # but makes it bombproof
        gidlist = db.wf_Seismogram.distinct("gridid")
        query = {idname: sid, "gridid": gidlist[0]}
...
def migrate_event(
    ...
    if n_total_this_sid <= minimum_data:
        ...
        print(
            f"number of plane wave Seismogram objects for sid={sid} is {n_total_this_sid}"
        )
    ...
    if monitor_memory or dryrun:
        # ignore source_collection to create this object
        # source_collection argument to the class is a relic
    ...
    if verbose:
        print(
            "Finsihed computing slowness vector grid.  Elapsed time=", time.time() - t0
        )
