...
from pwmigpy.ccore.gclgrid import GCLgrid, GCLgrid3d, r0_ellipse
...
def main(args=None):
    ...
    if create_3d:
        ...
        n3 = pf.get_long("n3")
    # this is the 2d grid
    g = GCLgrid(n1, n2, gridname, lat0, lon0, r0, azimuth_y, dx1, dx2, i0, j0)
    ...
    if create_3d:
        g3d = GCLgrid3d(
            n1, n2, n3, gridname, lat0, lon0, r0, azimuth_y, dx1, dx2, dx3, i0, j0
        )
        doc = GCLdbsave(
            db, g3d, collection=collection, dir=dir, dfile=dfile_base + "_3d"
        )
